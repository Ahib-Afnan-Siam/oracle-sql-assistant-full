...
class QueryClassifier:
    ...
    def _init_patterns(self):
        ...
        # Database query patterns - made more generic to avoid hardcoding specific queries
        self.database_patterns = [
            r'\b(dba|database|system|oracle|sql|session|tablespace|schema|object|user|invalid|constraint|index|view|procedure|function|trigger|package)\b',
            r'\b(metadata|administration|admin|performance|tuning|monitoring|statistics|privilege|grant|revoke)\b',
            r'\b(show\s+me.*database|list.*database|give\s+me.*database|total.*database|count.*database)\b',
            r'\b(free\s+space|used\s+space|storage|memory|sga|pga|buffer|cache|redo|undo|archive)\b'
        ]
        ...
        self.entity_patterns = {
            ...
            'database_entities': r'\b(dba|database|system|oracle|sql|session|tablespace|schema|object|user|invalid|constraint|index|view|procedure|function|trigger|package|metadata|administration|admin|performance|tuning|monitoring|statistics|privilege|grant|revoke|free\s+space|used\s+space|storage|memory|sga|pga|buffer|cache|redo|undo|archive)\b'
        }
    ...
    def _determine_strategy(self, intent: QueryIntent, confidence: float, complexity: float) -> ModelSelectionStrategy:
        ...
        # Database queries should use API-preferred strategy for better accuracy with system metadata
